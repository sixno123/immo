        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 z-50 flex w-[86%] max-w-sm flex-col bg-ivory-50 shadow-2xl lg:hidden"
            ...
            >
              ...
              <div className="border-t border-charcoal-700/10 px-6 py-6">
